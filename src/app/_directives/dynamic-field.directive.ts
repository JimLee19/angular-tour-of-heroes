...
import { DynamicFormControlComponent } from '../layout/dynamic-form-control/dynamic-form-control.component';
...
export class DynamicFieldDirective implements Field, OnChanges, OnInit {
    ...
    ngOnInit() {
        const component = this.resolver.resolveComponentFactory<Field>(DynamicFormControlComponent);
